...
class InspectionToolsDialog(tk.Toplevel):
    ...
    def _remove_periodic_pattern(self) -> None:
        ...
        if img is None:
            return
        try:
            from core.frequency import remove_periodic_pattern
        except ImportError:
            messagebox.showerror(
                "模組缺失", "無法載入 frequency 模組。", parent=self,
            )
    ...
    def _show_spectrum(self) -> None:
        ...
        if img is None:
            return
        try:
            from core.frequency import compute_fft, draw_spectrum
        except ImportError:
            messagebox.showerror(
                "模組缺失", "無法載入 frequency 模組。", parent=self,
            )
    ...
    def _color_sample(self) -> None:
        ...
        if img is None:
            return
        try:
            from core.color_inspect import (
                sample_color,
                sample_colors_grid,
            )
        except ImportError:
    ...
    def _sample_reference_color(self) -> None:
        ...
        if img is None:
            return
        try:
            from core.color_inspect import sample_color
        except ImportError:
            messagebox.showerror(
                "模組缺失", "無法載入 color_inspect 模組。", parent=self,
            )
    ...
    def _classify_color(self) -> None:
        ...
        if img is None:
            return
        try:
            from core.color_inspect import classify_color, sample_color
        except ImportError:
            messagebox.showerror(
                "模組缺失", "無法載入 color_inspect 模組。", parent=self,
            )
    ...
    def _check_uniformity(self) -> None:
        ...
        if img is None:
            return
        try:
            from core.color_inspect import check_color_uniformity
        except ImportError:
            messagebox.showerror(
                "模組缺失", "無法載入 color_inspect 模組。", parent=self,
            )
    ...
    def _extract_palette(self) -> None:
        ...
        if img is None:
            return
        try:
            from core.color_inspect import build_color_palette
        except ImportError:
            messagebox.showerror(
                "模組缺失", "無法載入 color_inspect 模組。", parent=self,
            )
    ...
    def _draw_ocr_results(self) -> None:
        ...
        if img is None:
            return
        try:
            from core.ocr_engine import draw_ocr_results
        except ImportError:
    ...
    def _scan_barcode(self) -> None:
        ...
        if img is None:
            return
        try:
            from core.barcode_engine import (
    ...
    def _draw_barcode_results(self) -> None:
        ...
        if img is None:
            return
        try:
            from core.barcode_engine import draw_barcode_results
        except ImportError:
            messagebox.showerror(
