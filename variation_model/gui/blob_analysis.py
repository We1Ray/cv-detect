...
class BlobAnalysisDialog(tk.Toplevel):
    ...
    def _build_ui(self) -> None:
        ...
        self._tree.heading("cx", text="Centroid X")
        self._tree.heading("cy", text="Centroid Y")
        self._tree.heading("bbox", text="BBox")
        self._tree.heading("circularity", text="Circularity")
        self._tree.heading("rectangularity", text="Rectangularity")
        self._tree.heading("convexity", text="Convexity")
        self._tree.heading("mean_gray", text="Mean Gray")
